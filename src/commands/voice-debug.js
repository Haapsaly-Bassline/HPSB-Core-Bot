  ...
  async execute(interaction, client) {
    ...
    try {
      ...
      lines.push(packets > 100
        ? 'Пакеты идут. СЛУШАЙ ВОЙС 60 сек: слышно радио — виноват discord-player; тишина при пакетах — UDP до Discord или мьют.'
      ...
      lines.push(`Состояние соединения на момент падения: ${st}`);
